<template>
  <section class="flex flex-col gap-4" v-if="selectedLocation">
    <h3 class="text-2xl font-bold">{{ selectedLocation.city }}, {{ selectedLocation.countryCode }}</h3>
    <span class="text-3xl pl-2 font-medium">{{ selectedLocation.tempC }}°C</span>
    <div class="flex flex-col gap-1">
      <span class="font-bold">Feels like {{ selectedLocation.feelsLikeC }}°C. {{ sentenceCase(selectedLocation.conditions) }}.</span>
